...
public class TreeUtils {
     ...
     * 列表转树
     *
     * @param data     实现{@link ITree}接口实体的集合实例
     * @param parentId 查询开始的父ID
     * @param <T>      id或者pid的类型泛型
     * @return {@link TreeNode}的集合实例
     * @see TreeUtils#createNode(List, Object, Comparator)
     */
    public static <T, S extends ITree<T>> List<TreeNode<T>> createNode(List<S> data, T parentId) {
     ...
     * @return {@link TreeNode}的集合实例
     */
    public static <T, S extends ITree<T>> List<TreeNode<T>> createNode(List<S> data, T parentId, Comparator<TreeNode<T>> comparator) {
     ...
     * @return 树形列表
     */
    private static <T> List<TreeNode<T>> doCreateNode(List<? extends ITree<T>> root, T parentId, Comparator<TreeNode<T>> comparator) {
    ...
    private static <T> List<TreeNode<T>> doCreateNode(Map<T, List<? extends ITree<T>>> map, T parentId, Comparator<TreeNode<T>> comparator) {
